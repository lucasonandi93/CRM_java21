...
```
cd existing_repo
git remote add origin https://gitlab.com/lucasonandi93/crm_java21.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/lucasonandi93/crm_java21/-/settings/integrations)
